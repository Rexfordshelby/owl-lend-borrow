...
CREATE INDEX idx_conversations_request_id ON public.conversations(borrow_request_id);
CREATE INDEX idx_messages_conversation_id ON public.messages(conversation_id);
CREATE INDEX idx_messages_created_at ON public.messages(created_at);
CREATE INDEX idx_borrow_requests_status ON public.borrow_requests(status);
CREATE INDEX idx_borrow_requests_last_message ON public.borrow_requests(last_message_at);
